# GCSE Physics (AQA 8463) — Course Reference

## Subject

GCSE Physics, AQA specification 8463.

- **Paper 1** (1h 45m, 100 marks): Topics 1–4
- **Paper 2** (1h 45m, 100 marks): Topics 5–8
...
| Slug | File |
|------|------|
| energy | `curriculum/topics/1-energy.md` |
| electricity | `curriculum/topics/2-electricity.md` |
| particle-model | `curriculum/topics/3-particle-model.md` |
| atomic-structure | `curriculum/topics/4-atomic-structure.md` |
| forces | `curriculum/topics/5-forces.md` |
| waves | `curriculum/topics/6-waves.md` |
| magnetism | `curriculum/topics/7-magnetism.md` |
| space | `curriculum/topics/8-space.md` |

## Curriculum File Structure

Each topic file follows the same template:

1. **Key Concepts** — syllabus breakdown with subsections matching AQA spec (e.g. 5.1, 5.2)
...
Student data lives under `students/[name]/gcse-physics/`:

```
students/[name]/gcse-physics/
...
5. **Be specific** — "struggles with conservation of energy" not "needs work"
